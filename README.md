...
<div style="display: inline_block; margin-bottom: 20px" align="center"/>
  ...
  [![My Skills](https://skillicons.dev/icons?i=nextjs,threejs,solidity,ipfs,vercel,express,flask,django,jquery,postman,prisma,reactivex,styledcomponents,vite,aws,gcp,svg,md,powershell,bash,linkedin,devto,kafka,idea)](https://skillicons.dev)
