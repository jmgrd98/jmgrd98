...
<div style="display: inline_block; margin-bottom: 20px" align="center"/>
  ...
  [![My Skills](https://skillicons.dev/icons?i=bootstrap,tailwind,nextjs,threejs,solidity,vercel,express,flask,django,postman,prisma,reactivex,styledcomponents,vite,aws,gcp,powershell,bash,kafka,hibernate,graphql,anaconda,discord,devto,sklearn)](https://skillicons.dev)
